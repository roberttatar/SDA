...
public class Square implements Shape{
	...
	public double getArea() {//returneaza aria la patrat
		boolean ok=validateDimensions.validateSquare(size);//boolean poate fi adevarat sau fals, un fel de apel
	...
	public int getBorderWidth() {//afiseaza chenar
	...
	String a[][]=new String[size][size];//[]dimensiuniile
